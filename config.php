...
/**
 * Config file for bumobile theme
 *
 * @package    theme
 * @subpackage bumobile
 * @copyright  John Stabinger, Kyle Temkin
...
if ($thisdevice == "default" || $thisdevice == "tablet" || optional_param('bumobile_blocks', false, PARAM_BOOL)) {
...
$THEME->csspostprocess = 'bumobile_user_settings';
