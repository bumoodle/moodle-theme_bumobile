...
/**
 * General layout for the bumobile theme
 *
 * @package    theme
 * @subpackage bumobile
...
// get blocks?
$toblock = optional_param('bumobile_blocks', false, PARAM_BOOL);
// get settings?
$toset = optional_param('bumobile_settings', false, PARAM_BOOL);
...
$urlblocks = new moodle_url($PAGE->url, array('bumobile_blocks' => 'true'));
$urlsettings = new moodle_url($PAGE->url, array('bumobile_settings' => 'true'));
...
if ($gowide) {
    ...
    bumobile_initialise_colpos($PAGE);
}
$usercol = (bumobile_get_colpos() == 'on');

$renderer = $PAGE->get_renderer('theme_bumobile');

echo $OUTPUT->doctype() ?>
<html id="bumobile" <?php echo $OUTPUT->htmlattributes() ?>>
<head>
...
<body id="<?php p($PAGE->bodyid) ?>" class="<?php p($PAGE->bodyclasses.' '.join(' ', $bodyclasses)) ?>">
    ...
    <div id="<?php p($PAGE->bodyid) ?>PAGE" data-role="page" class="generalpage <?php echo 'ajaxedclass '; p($PAGE->bodyclasses.' '.join(' ', $bodyclasses));  ?> <?php if ($hasmyblocks && $usercol) { echo 'has-myblocks'; } ?> " data-title="<?php p($SITE->shortname) ?>">
        ...
        <!-- main content -->
        <div data-role="content" class="bumobilecontent" <?php echo $databodytheme; ?>>
          ...
          <?php } ?>
            ...
            <div class="content-secondary">
                ...
                <div data-role="fieldcontain" id="sliderdiv">
                    <label for="slider"><?php p(get_string('mtoggle','theme_bumobile')); ?>:</label>
