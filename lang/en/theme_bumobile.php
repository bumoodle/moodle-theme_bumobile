...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Mobile@BU</h2><img src="bumobile/pix/screenshot.png" /><h2>About</h2><p>Mobile@Bu is a modified version of MyMobile for Moodle 2.x. More information on modifying themes can be found in the <a href="http://docs.moodle.org/en/Theme">MoodleDocs</a>.</p></div></div>';
